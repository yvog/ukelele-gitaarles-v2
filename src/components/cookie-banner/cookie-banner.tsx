...
export const CookieBanner = () => {
  const { declineAllCookies, acceptCookies, acceptAllCookies, consent } =
    useCookieConsentContext();

  const preferencesGiven = typeof consent.thirdParty != 'undefined';
      ...
      >
        ...
        <div id="cookiebanner-content">
          <p>
            ...
            werking van de website. De analytische cookies worden gebruikt voor
            het verkrijgen van anonieme gebruikersinzichten.
          </p>
