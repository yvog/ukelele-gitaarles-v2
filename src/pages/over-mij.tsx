    ...
    <Layout title="Over mij" canonical="/over-mij">
      ...
      >
        ...
        <p>
          ...
          <strong>Leon van Veen (Koninklijk Conservatorium, Den Haag)</strong>. Daar ik mijn
          muzikale horizon wilde verbreden, ben ik destijds ook met de gitaar aan de slag gegaan.
          Eerst begonnen met het ontdekken van de klassieke gitaar en later kwam daar rockgitaar
          bij. Ik vond gitaarspelen zo geweldig dat het mijn hoofdinstrument is geworden en de piano
          mijn tweede instrument.
        </p>
        <p>
          ...
          <strong>Lead- en Rhythm- gitarist</strong> in verschillende Christelijke producties, zoals
          de musicals: Jesus Christ Superstar (1990-1991), The Story of J.C. (1996), Starring Peter
          (1997-Frank Sanders), Josef and the Amazing Technicolor Dreamcoat (1998) en Tamara (2000).
          Later speelde ik nog een aantal jaren gitaar bij{' '}
        ...
        <p>
          ...
          Momenteel draag ik mijn muzikaal spel bij “De Band” in Koudekerk aan den Rijn (ukelele en
          gitaar).
        </p>
        <p>
          Het geeft mij niet alleen enorme voldoening om mijn muzikale kennis op dit gebied over te
          brengen aan jonge of oudere leerlingen, ook geeft het mij plezier de opgedane ervaringen
          met hen te delen.
        </p>
      </ContentBlock>
      ...
      <div className={classNames('main-container', styles.about_me_usps)}>
        <UspItem icon="/images/icon/icon_metronome.svg">
          Met veel geduld wordt je begeleid gedurende het leerproces. Leer muziekspelen op je eigen
          tempo
        </UspItem>
